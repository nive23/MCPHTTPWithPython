"""
HTTP/SSE version of Salesforce Quote MCP Server
This version can be hosted on web servers and accessed via HTTP
"""
import time
import sys
import socket
...
# MCP Server & Tools
# -------------------------------------------------
mcp = FastMCP(name="salesforce-quote")
...
if __name__ == "__main__":
    ...
    print(f"Starting Salesforce Quote MCP server on {host}:{port}...", file=sys.stderr)
